...
def run_pipeline(
    ...
    final_srt = output_path or video_path.with_suffix(".srt")
    ...
    run_stage(
        PipelineStage(3, "standardize_srt", {"input": raw_srt}),
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        output = run_pipeline(args.video_file, args.provider, args.model, args.language, args.output)
